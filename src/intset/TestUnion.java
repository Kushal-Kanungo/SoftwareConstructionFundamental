...
class TestUnion {
	...
	public static Stream<Arguments> object() {
		return Stream.of(
				...
				Arguments.of(new int[] {4,6,8}, new int[] {5,7,9}, new int[] {4,5,6,7,8,9}),
				Arguments.of(new int[] {1,1,1,1,5,5}, new int[] {1,1,1,5,6}, new int[] {1,5,6})
				);
	}
	...
	public void object(int[] firstSetArray ,int[] secondSetArray, int[] expected) {
		...
		assertArrayEquals(expected, firstSet.unionWith(secondSet).getValues());
